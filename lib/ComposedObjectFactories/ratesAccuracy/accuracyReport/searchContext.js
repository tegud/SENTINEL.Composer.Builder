...
var searches = {
	'ks': { mapper: setQuickSearch.bind(undefined, 'keyword', /^ks([0-9]+)_([A-Z\-]+)_([A-Z\- ]+)(\-p([0-9]+))?\.aspx$/i) },
	'k': { mapper: setStandardSearch.bind(undefined, 'keyword', /^k([0-9]+)_([A-Z\- ]+)\-hotels(\-p([0-9]+))?\.aspx$/i ) },
